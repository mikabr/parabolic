...
plt(row(diamond, 3))
plt(bottom.pyramid(diamond, 2))
plt(meta.diamond(diamond, 3))
ggsave("~/Documents/meta.diamond.7.pdf", width = 36, height = 36, dpi = 300)
ggsave("~/Documents/meta.diamond.3.png", width = 12, height = 12, dpi = 300)
